    ...
    <div className="fade-up">
      <div style={{ position: 'relative', marginBottom: 16 }} className="px-mobile">
        ...
        <input
          ...
          style={{ width: '100%', height: 46, borderRadius: 12, border: '1px solid rgba(255,255,255,.1)', background: '#1A100C', padding: '0 44px 0 16px', fontSize: 14, fontFamily: 'inherit', color: '#F5EDE4', outline: 'none' }}
        />
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: 12 }} className="catalog-grid px-mobile">
        ...
        {filtered.length === 0 && (
          <div style={{ gridColumn: '1/-1', textAlign: 'center', padding: '60px 20px', color: '#7A5F50' }}>לא נמצאו נתחים</div>
        )}
      </div>
    </div>
  );
